...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2018 at 04:29 AM
...
(2, 'Metrobank', 2, 100, 10.3692, 123.917, 7, 100, 'Gov. M. Cuenco Ave'),
...
(5, '2018-01-17 14:46:27', 123, 1),
(6, '2018-01-17 14:46:51', 123, 5);
...
(2, 'Kent Dazo', 'Volunteer', 'Talamban, Cebu City', '09254853869');
...
--
ALTER TABLE `item`
  MODIFY `item_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `packagedistribution`
--
ALTER TABLE `packagedistribution`
  MODIFY `packdist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
