                      ...
                      <a class="nav-link collapsed" href="#submenu2" data-toggle="collapse" data-target="#submenu2"><i class="material-icons">build</i>  Services</a>
                        <div class="collapse" id="submenu2" aria-expanded="false">
                              <ul class="flex-column pl-2 nav">
                                  ...
                                  <li class="nav-item"><a class="nav-link pt-1" href="evacuationCenter.php">Evacuation Centers</a></li>
                                  <li class="nav-item"><a class="nav-link pt-1" href="message.php">Messages</a></li>
                              </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link collapsed" href="#submenu3" data-toggle="collapse" data-target="#submenu3"><i class="material-icons">insert_chart</i>  Reports</a>
                        <div class="collapse" id="submenu3" aria-expanded="false">
                              <ul class="flex-column pl-2 nav">
                                  <li class="nav-item"><a class="nav-link pt-1" href="evacCenterReport.php">Evacuation Center</a></li>
                                  <li class="nav-item"><a class="nav-link pt-1" href="healthStatusReport.php">Health Status</a></li>
                                  <li class="nav-item"><a class="nav-link pt-1" href="reliefDistributionReport.php">Relief Distribution</a></li>
                              </ul>
                        </div>
                    </li> 
                    <li class="nav-item">
