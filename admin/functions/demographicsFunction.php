...
class Demographics
{
	...
	public function retrieveNumberOfFamiliesEvacuated($evac_id)
	{
	...
	public function retrieveNumberOfEvacueesInSpecificEvac($evac_id)
	{
	...
	public function retrieveNumberOfFemaleEvacueesInSpecificEvac($evac_id)
	{
	...
	public function retrieveNumberOfMaleEvacueesInSpecificEvac($evac_id)
	{
	...
	public function retrieveNumberOfInfected($evac_id)
	{
		$sql = "SELECT COUNT(a.resident_id) as infected, b.disease_name FROM diseaseacquired as a JOIN disease as b ON a.disease_id = b.disease_id JOIN resident as c ON a.resident_id = c.resident_id JOIN attendance as d ON c.resident_id = d.resident_id WHERE d.evac_id ='".$evac_id."' GROUP BY b.disease_name";
		$itemArray = array();
		$query = mysqli_query($this->conn, $sql);
