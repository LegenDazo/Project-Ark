                                  ...
                                  foreach ($myrow as $row) {
                                    ?>
                                      ...
                                      <tr>
                                        ...
                                        <td><a href="viewOperationDetails.php?operation_id=<?php echo $row['operation_id'];?>" class="btn btn-info">View Details</a>&nbsp;<a href="adminOperation.php?operation_id=<?php echo $row['operation_id'];?>" class="btn btn-danger">DELETE</a></td>
