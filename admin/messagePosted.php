...
?>
<!DOCTYPE html>
<?php include 'adminMessageFunctions.php'; 
?>
<html lang="en">
<head>
                  ...
                  <div class="container" style="margin-top: 5%;">
                      ...
                      <div class="container" style="margin-top: 5%">
                        ...
                        <div class="panel panel-default">
                          <div class="panel-heading"><h2 align="center">Message Successfully Sent!</h2></div>               
                        </div><!-- end of .panel .panel-default-->
                        
                        <div class="text-right">
                            <a href="adminMessage.php" class="btn btn-warning">BACK</a>
                        </div>  
