...
(16, 'Diarrhea'),
(17, 'Flu'),
(18, 'Abdominal Aortic Aneurysm — see Aortic Aneurysm'),
...
(30, 'African Trypanosomiasis — see Sleeping Sickness'),
(31, 'Agricultural Safety — see Farm Worker Injuries'),
...
(40, 'American Trypanosomiasis — see Chagas Disease'),
...
(46, 'Babesia Infection — see Babesiosis'),
(47, 'Babesiosis [Babesia Infection]'),
(48, 'Bacillus anthracis — see Anthrax'),
(49, 'Back Belts — see Ergonomic and Musculoskeletal Disorders'),
...
(21, 'Jia', 'Banks', 'Go', 'Female', '2015-11-28', 3, 'dependent', 9),
...
(28, 'Derrick', 'Corey', 'Bartolome', 'Male', '1971-03-25', 3, 'head', 11),
...
(33, 'Frank', 'Day', 'Silva', 'Male', '1970-07-08', 2, 'head', 12),
(34, 'Britt', 'Cohen', 'Silva', 'Female', '1975-06-09', 2, 'head''s spouse', 12),
(35, 'Martin', 'Cohen', 'Silva', 'Male', '2000-05-08', 2, 'dependent', 12),
(36, 'Jack', '', 'Mcdaniel', 'Male', '1960-06-09', 2, 'head', 13),
(37, 'Carla', 'Doss', 'Mcdaniel', 'Female', '1965-08-09', 2, 'head''s spouse', 13),
(38, 'Wardell', 'Doss', 'Mcdaniel', 'Male', '1995-04-05', 2, 'dependent', 13),
(39, 'Jay', 'Lee', 'Park', 'Male', '1990-10-11', 2, 'head', 14),
(40, 'Sandara', 'Han', 'Park', 'Female', '1992-12-15', 2, 'head''s spouse', 14),
(41, 'Alex', 'Xander', 'Ford', 'Male', '1960-10-05', 2, 'head', 15),
(42, 'Maria', 'Noel', 'Ford', 'Female', '1965-02-11', 2, 'head''s spouse', 15),
(43, 'Brad', 'Noel', 'Ford', 'Male', '2000-01-01', 2, 'dependent', 15);
...
--
ALTER TABLE `disease`
  MODIFY `disease_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
--
...
--
ALTER TABLE `packagedistribution`
  MODIFY `packdist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
